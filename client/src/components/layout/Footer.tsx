    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-2xl font-bold">Careervue</span>
            </div>
            <p className="text-gray-300">
              Your trusted partner in finding the perfect career opportunity.
              Connecting talent with opportunities across government and private
              sectors.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">malwatkarpranav@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                {/* Replace Phone icon with LinkedIn icon if available, else use Mail or Briefcase */}
                <a
                  href="https://www.linkedin.com/in/pranav-malwatkar-9834b1239/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-300 hover:text-blue-400 transition-colors"
                >
                  {/* You can use a LinkedIn SVG/icon here if you have one */}
                  <svg
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2025 Careervue. All rights reserved. | Privacy Policy | Terms of
            Service
          </p>
        </div>
      </div>
